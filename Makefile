...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/georgecpp/go-simplebank/db/sqlc Store
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/georgecpp/go-simplebank/worker TaskDistributor
